...
class AlphaChatContainer(context: Context) {
    ...
    val relayPreferencesRepository = RelayPreferencesRepository(appContext)
    ...
    private val torRuntime = EmbeddedTorRuntime(appContext, scope)
    private val relayTransport = RelayHttpMeshTransport(
        ...
        initialSharedSecret = null // secret charge ensuite depuis DataStore (UI)
    )
    ...
    val relayControl: RelayTransportControl = relayTransport
